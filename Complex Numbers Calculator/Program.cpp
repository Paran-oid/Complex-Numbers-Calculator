...
void Program::display_result(Complex_Number result)
{
...
Complex_Number Program::handle_choice(vector <Complex_Number> complexNumbers, string op)
{
	Complex_Number res;
	if (op == "+")
	{
...
Complex_Number Program::add(vector<Complex_Number> complexNumbers)
{
	int rel = 0;
	int im = 0;
...
Complex_Number Program::minus(vector<Complex_Number> complexNumbers)
{
...
Complex_Number Program::multiply(vector<Complex_Number> complexNumbers)
{
	int rel = complexNumbers[0].getRel();
	int im = complexNumbers[0].getIm();
